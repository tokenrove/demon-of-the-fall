...
not mean ``from the upper-left corner of the sprite''.  For the
moment, just pass src-rect as NIL until I write decent rectangle
routines or I improve this interface."
  ;;; XXX fix types
